...
export class IconLocationDirective {
  ...
  public get isIconOnLeft(): boolean {
    return (
      this.iconLocation === 'left' && this.el.nativeElement.localName === 'i'
    );
  }
  ...
  public get isIconOnRight(): boolean {
    return (
      this.iconLocation === 'right' && this.el.nativeElement.localName === 'i'
    );
  }
  ...
  public get hasIconOnLeft(): boolean {
    return (
      ...
      this.el.nativeElement.localName === 'input'
    );
  }
